...
if(True):#os.path.isfile('./certs/iMessager.crt') and os.path.isfile('./certs/iMessager.key')):
    print("https:")
    https_server = WSGIServer(('', getConfig()["port"]), app,certfile='./certs/development.crt', keyfile='./certs/development.key')
